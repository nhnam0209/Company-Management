<?php
  ...
  $sql1 = "SELECT id, task.eid, task.tname, task.deadline, task.subdate, task.stt, task.descript, task.rating, employee.firstname, employee.lastname FROM `task` ,`employee`  WHERE task.eid = $id AND task.tid = $tid AND employee.id = task.eid ";
  ...
  <div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    <h2 class="title_header">Approve Task</h2>
                    <form id = "registration" action="process/approvetasks.php" method="POST">
                        ...
                        <div class="container_form_edit">
                          <div class="form_text">
                              ...
                              <div class="row">
                                  ...
                                  <div class="col-75">
                                    <input class="input--style-1" type="text" name="stt"  disabled="disabled" value="Completed">
                                  </div>
                              </div>     
                              <div class="row">
                                  <div class="col-25">
